...
#if defined(USE_ISO14443A_SUBCARRIER_DIVIDER_NBR106) && \
    (!defined(USE_ISO14443A_SUBCARRIER_DIVIDER_NBR424) || USE_ISO14443A_SUBCARRIER_DIVIDER_NBR424 == 0)
    /* Sets the default ISO1443A NFC transfer baud rate to ~106 kbps: */
    #define ISO14443A_SUBCARRIER_DIVIDER    128
#elif defined(USE_ISO14443A_SUBCARRIER_DIVIDER_NBR424) && USE_ISO14443A_SUBCARRIER_DIVIDER_NBR424 != 0
    /* Sets the default ISO1443A NFC transfer baud rate to ~424 kbps: */
    #define ISO14443A_SUBCARRIER_DIVIDER    32
#else
